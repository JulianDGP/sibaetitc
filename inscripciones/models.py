...
class Tipo_afiliacion(Modelo):
    id_tipo_afiliacion = models.AutoField(
        primary_key=True
    )
...
class Inscripcion( Modelo ):
    id_inscripcion = models.AutoField(
        primary_key=True
    )

    beneficiario_inscripcion = models.ForeignKey(
        Beneficiario,
        help_text='Beneficiario inscripción',
        verbose_name='Beneficiario inscripción',
        on_delete=False
    )
    servicio_inscripcion = models.ForeignKey(
        Servicio,
